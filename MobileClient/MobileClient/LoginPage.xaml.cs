...
namespace MobileClient
{
    ...
    public partial class LoginPage : ContentPage
    {
        ...
        public LoginPage(ChatServiceClient chatServiceClient = default,
        ...
        private async Task LoginToServer()
        {
            try
            {
                ...
                {
                    await Navigation.PushAsync(new ChatPage(ChatServiceClient, Login, Password, Ip, Port, ans.Sid.Guid_));
                }
            }
